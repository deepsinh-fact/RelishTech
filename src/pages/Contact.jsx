                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:dhaval@relishtechglobal.com" className="text-indigo-600 hover:text-indigo-800">
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919925098997" className="text-indigo-600 hover:text-indigo-800">
                                            +91 99250 98997
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://www.relishtechglobal.com" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">
