            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                    {servicesDelivered.map((service, index) => (
                        <div
                            key={service.id}
                            className={`group relative bg-gradient-to-br from-[#1a2f5a] to-[#0f1d3a] backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl 
                                       hover:shadow-blue-500/30 hover:shadow-2xl transition-all duration-500 
                                       overflow-hidden border border-blue-400/20 hover:border-blue-300/50 
                                       transform hover:-translate-y-1 sm:hover:-translate-y-2 cursor-pointer
                                       hover:from-[#1e3461] hover:to-[#132040] ${hoveredIndex === index ? 'sm:scale-105' : ''}`}
                        ...
                        >
                            ...
                            <div className="h-32 sm:h-40 lg:h-44 bg-gray-200 flex items-center justify-center relative overflow-hidden">
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-blue-800/50 to-purple-800/50 flex items-center justify-center"
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-blue-200 font-medium">Service</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 sm:p-6 relative z-10">
                                <h3 className="text-base sm:text-lg font-bold text-white mb-2 sm:mb-3 leading-tight 
                                             group-hover:text-blue-200 transition-colors duration-300 line-clamp-2">
                                    {service.title}
                                </h3>
                                ...
                                <div className="mt-3 sm:mt-4 flex items-center text-blue-300 opacity-0 
